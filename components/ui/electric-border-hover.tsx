...
const ElectricBorderHover: React.FC<ElectricBorderHoverProps> = ({
  children,
  color = '#00ff00',
  speed = 1,
  chaos = 1,
  ...
  }, [speed, chaos, isHovered]);

  useLayoutEffect(() => {
    if (!rootRef.current) return;
    const ro = new ResizeObserver(() => {
      if (isHovered) updateAnim();
    });
...
export default ElectricBorderHover;
